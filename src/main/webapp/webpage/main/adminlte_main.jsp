...
<head>
	...
	<meta name="keywords" content="汇智为民(天津)科技有限公司">
    <meta name="description" content="汇智为民(天津)科技有限公司">
...
<div class="wrapper">
            ...
            <ul class="dropdown-menu">
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="javascript:window.open('http://www.hzwm.com.cn')" title="云应用中心">
  ...
  <footer class="main-footer">
    ...
    <a href="http://www.hzwm.com.cn" title="汇智为民(天津)科技有限公司">汇智为民(天津)科技有限公司</a>
           (推荐谷歌浏览器，获得更快响应速度) 技术支持:
           <a href="#" title="汇智为民(天津)科技有限公司">汇智为民(天津)科技有限公司</a>
  </footer>
