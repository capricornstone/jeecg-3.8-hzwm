      ...
      <div class="col-sm-10 col-sm-offset-1">
        <div class="login-container">
          <div class="center">
            ...
            <h4 class="blue" id="id-company-text">www.hzwmin.com.cn</h4>
          </div>
          ...
          <div class="position-relative">
                 ...
                 <div class="alert alert-warning alert-dismissible" role="alert" id="errMsgContiner">
                  ...
                  <div class="space-6"></div>
                      ...
                      <div class="clearfix">
                        ...
                        <span> | <a href="http://www.hzwm.com.cn"><i class="ace-icon fa fa-location-arrow"></i><font color='#428bca'>移动OA</font></a></span>
                         <span> | <a href="http://www.hzwm.com.cn" target="_blank"><i class="ace-icon fa fa-cube"></i><font color='#428bca'>插件中心</font></a></span>
            ...
            <div class="center"><h4 class="blue" id="id-company-text">&copy; 汇智为民(天津)科技有限公司版权所有</h4></div>
