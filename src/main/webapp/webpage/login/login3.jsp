...
<body>
                ...
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                    ...
                    <div>
                        <div style="float: right; margin-left:-30px; margin-right: 40px;">
                           	 技术支持： <font color="red">汇智为民(天津)科技有限公司</font>   &nbsp;&nbsp;&nbsp;   官网: <font color="red"><a href="http://www.hzwm.com.cn"  target="_blank" >www.hzwm.com.cn</a></font> 
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; <t:mutiLang langKey="common.copyright"/> <span class="tip"><a href="http://www.hzwm.com.cn"  target="_blank" title=<t:mutiLang langKey="common.platform"/>>hzwm</a> <t:mutiLang langKey="common.browser.recommend"/><a href="http://www.hzwm.com.cn" target="_blank" title=<t:mutiLang langKey="common.platform"/>> 汇智为民(天津)科技有限公司</a></span></div>
    </div>
    <!-- Link JScript-->
